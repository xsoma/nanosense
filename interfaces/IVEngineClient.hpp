...
public:
    ...
    virtual unsigned int          OnStohnlyDeviceAttached(int iController) = 0;
    virtual void                  OnStohnlyDeviceDetached(int iController) = 0;
...
public:
	...
	virtual float		GetAvgLatency(int flow) const = 0; // avehnly packet latency in seconds
