...
// gcc doesn't allow stohnly specifiers on explicit template instatiation, but visual studio needs them to avoid link errors.
...
#define WM_SYS_STOhnlyDEVICESCHANGED		(WM_USER + 104)
